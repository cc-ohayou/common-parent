...
import static com.ccspace.facade.domain.common.constants.CommonConstants.POST;
import static com.ccspace.facade.domain.common.constants.CommonConstants.UTF8;
...
public class RequestUtils {
    ...
    public static String getRequestedSessionId(HttpServletRequest request) {
        ...
        if (request.isRequestedSessionIdFromURL() || StringUtils.isBlank(ctx)) {
            ...
            // 手动从cookie获取
            Cookie cookie = CookieUtils.getCookie(request, CommonConstants.JSESSION_COOKIE);
            if (cookie != null) {
